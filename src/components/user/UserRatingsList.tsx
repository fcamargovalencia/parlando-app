...
const ICON_MSG_SM = <MessageCircle size={16} color={Colors.primary[600]} />;
const ICON_MSG_LG = <MessageCircle size={28} color={Colors.neutral[300]} />;
...
export const UserRatingsList = React.memo(function UserRatingsList({ ratings, withComment }: Props) {
  return (
    <Card>
